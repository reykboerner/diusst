...
# Load dataset
data_orig1_dirty = pd.read_csv(data_path+data_filename)[data_interval1[0]:data_interval1[1]]
data_orig1 = data_orig1_dirty.drop(data_orig1_dirty.index[removeidx])
