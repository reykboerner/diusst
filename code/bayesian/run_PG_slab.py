...
def bayesian_likelihood(params):
    ...
    simu1 = Slab(d=d, Q_sink=Q_sink, xi_1=xi_1, xi_2=xi_2, T_f=ftemp1).simulate(
            times1, wind1, swrad1, atemp_rel1, humid1)

    simu2 = Slab(d=d, Q_sink=Q_sink, xi_1=xi_1, xi_2=xi_2, T_f=ftemp2).simulate(
            times2, wind2, swrad2, atemp_rel2, humid2)
